...
json.dump({
  ...
  "PINECONE_API_KEY": "SET_ME", "PINECONE_INDEX_NAME": "SET_ME", "PINECONE_NAMESPACE": "SET_ME",
...
GCS_MEDIA_BUCKET GEMINI_API_KEY GMAIL_AUTO_SYNC GMAIL_CLIENT_ID GMAIL_CLIENT_SECRET GMAIL_REDIRECT_URI GMAIL_REFRESH_TOKEN GMAIL_SENDER_EMAIL
GOOGLE_CLOUD_PROJECT GOOGLE_MAPS_GEOCODING_API_KEY GROQ_MODEL MEDIA_STORAGE NEXT_PUBLIC_SUPABASE_ANON_KEY NEXT_PUBLIC_SUPABASE_URL OWNER_WHATSAPP_NUMBERS
S3_MEDIA_BUCKET S3_MEDIA_REGION STORAGE_PROVIDER SUPABASE_OPTIMIZED_BUCKET SUPABASE_SERVICE_ROLE_KEY SUPABASE_THUMB_BUCKET SYNC_AUTO_ENABLED
