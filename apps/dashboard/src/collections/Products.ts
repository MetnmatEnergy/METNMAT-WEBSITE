...
export const Products: CollectionConfig = {
  ...
  versions: { drafts: true }, // publish/unpublish + revision history
  fields: [
    {
      type: "row",
      fields: [
    ...
    // Media (requirement 5: multiple product images)
    {
      name: "images",
      type: "array",
    ...
    // Documents (brochures / datasheets / certificates)
