  ...
  return (
    ...
    >
      <Container className="flex flex-col items-center gap-x-6 gap-y-1 py-2.5 text-center text-sm sm:flex-row sm:justify-center sm:text-left">
        <p className="flex items-start gap-2 font-medium text-amber-800 dark:text-amber-300 sm:items-center">
          <Wrench aria-hidden className="mt-0.5 h-4 w-4 shrink-0 sm:mt-0" />
          <span>{notice.message}</span>
        </p>
        {settings && (
          <p className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-amber-800 dark:text-amber-300/90">
            <span className="hidden sm:inline" aria-hidden>
              ·
            </span>
            <span>
              Need help? Contact our{" "}
              <Link href="/contact" className="font-semibold underline underline-offset-4 hover:text-amber-900 dark:hover:text-amber-200">
                customer service
              </Link>
            </span>
            {settings.contact.email && (
              <a
                ...
                className="inline-flex items-center gap-1 font-medium underline underline-offset-4 hover:text-amber-900 dark:hover:text-amber-200"
              >
